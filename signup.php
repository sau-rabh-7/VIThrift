...
<body>
    ...
    <div class="form">
        <form action="login.php" method="post">
            <div class="form-item">
                <div class="form-type">Signup</div>
            </div>
            <div class="form-item">
                <input type="text" placeholder="Enter Your Username" name="user_name" class="form-input">
            </div>
            <div class="form-item">
                <input type="password" placeholder="Enter Your Password" name="password" class="form-input">
            </div>
            <div class="form-item">
                <input type="submit" value="Signup" name="login" class="btn">
            </div>
            <div class="form-item">
